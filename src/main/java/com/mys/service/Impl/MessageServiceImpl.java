...
import com.mys.dao.MessageDao;
import com.mys.entity.Message;
import com.mys.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public int saveMessage(Message message,Message parentMessage) {
        ...
        if(!StringUtils.isEmpty(parentMessage)){
            ...
            String comtent = "亲爱的" + parentNickname + "，您在【Supxiaoxinの客栈】的评论收到了来自" + nickName + "的回复！内容如下：" + "\r\n" + "\r\n" +  message.getContent();
            String parentEmail = parentMessage.getEmail();

            // 发送邮件
            SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
            simpleMailMessage.setSubject("Supxiaoxinの博客馆评论回复");  //主题
            simpleMailMessage.setText(comtent);   //内容
            simpleMailMessage.setTo(parentEmail); //接收者的邮箱
            simpleMailMessage.setFrom("hx19461212@126.com");//发送者邮箱
